...
DD_belatedPNG.fix( '.logobox a img' );
DD_belatedPNG.fix( '#thumbNav' );
DD_belatedPNG.fix( '#thumbNav a' );
DD_belatedPNG.fix( 'blockquote' );
DD_belatedPNG.fix( '.slider .anythingSlider a' );
DD_belatedPNG.fix( '.pattern_big' );
DD_belatedPNG.fix( '.sidebar' );
DD_belatedPNG.fix( '.sidebar_right' );
DD_belatedPNG.fix( '.content_main .team_list li' );
DD_belatedPNG.fix( '#footer .templatic' );
DD_belatedPNG.fix( '#footer' );
DD_belatedPNG.fix( '.shadowbox' );
