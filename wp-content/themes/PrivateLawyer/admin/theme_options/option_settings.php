...
{
// enqueue styles
wp_enqueue_style( 'option-tree-style',TT_THEME_OPTIONS_FOLDER_URL.'css/style_option_tree.css', false, 1, 'screen');	
// enqueue scripts
add_thickbox();
...
{
	if(isset($_REQUEST['ajaxact']) && $_REQUEST['ajaxact']=='save_options')
	{
		if($_POST)
		{
		...
		exit;
	}elseif(isset($_REQUEST['ajaxact']) && $_REQUEST['ajaxact']=='reset_options')
	{
