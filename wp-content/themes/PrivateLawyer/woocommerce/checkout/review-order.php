	...
	<div id="payment">
		...
		<div class="form-row place-order">
			...
			<p class="form-row terms">
				<label for="terms" class="checkbox"><?php _e('I accept the', 'woocommerce'); ?> <a class="lightbox-iframe" href="https://iq-express.com/EULA.html" target="_blank"><?php _e('EULA', 'woocommerce'); ?></a></label>
