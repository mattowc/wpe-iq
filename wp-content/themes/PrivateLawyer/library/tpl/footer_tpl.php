		...
		<div id="footer">
            <div class="row">
                <div class="column column-3">
                    <h3>About</h3>
                    <p><img width="50" height="43" src="/wp-content/uploads/2013/01/brain.png" class="logo">IQ Express, by Learning Technics, is a learning program for treating and curing learning problems like ADHD, Dyslexia, Auditory Processing Disorder, Dysgraphia, and other learning disabilities. It uses a technique called Physio-Neuro therapy to help rewire the brain. Fully utilizing the brain's ability to heal itself, neuroplasticity.</p>
                </div>
                <div class="column column-3">
                    <h3>Support</h3>
                ...
                <div class="column column-3">
                    <h3>Contact</h3>
                    <ul>
                        <li><strong>Phone</strong>: 800-893-9315</li>
                        <li><strong>Email</strong>: support@iq-express.com</li>
                        <li><strong>Hours</strong>: M-F 10-6pm MST</li>
                    </ul>
                </div>
            </div>
