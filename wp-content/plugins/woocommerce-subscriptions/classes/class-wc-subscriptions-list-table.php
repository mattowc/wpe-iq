	...
	function sort_subscriptions( $a, $b ){
		...
		switch ( $order_by ) {
			...
			case 'end_date' :
				...
				break;
			case 'next_payment_date' :
				$next_payment_a = WC_Subscriptions_Manager::get_next_payment_date( $a['subscription_key'], $a['user_id'], 'timestamp' );
				$next_payment_b = WC_Subscriptions_Manager::get_next_payment_date( $b['subscription_key'], $b['user_id'], 'timestamp' );
