...
<div class="iphorm-help-right">
    <div class="updated inline"><p><?php printf(esc_html__('The help included with the plugin is no longer being updated and will be removed in a future version, please visit %s for comprehensive documentation and support forums.'), '<a href="http://support.themecatcher.net">http://support.themecatcher.net</a>'); ?></p></div>
    <h2>Basics</h2>
