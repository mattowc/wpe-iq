...
function woocommerce_ups_init() {
	...
	class WC_Shipping_UPS extends WC_Shipping_Method {
		...
		function __construct() {
			...
			$this->residential_address = $this->settings['residential_address'];
		...
		function init_form_fields() {
			...
			$this->form_fields = array(
			    ...
			    'custom_box_weight' => array(
					'title' => __('Maximum box weight', 'woothemes'),
					'type' => 'text',
					'class' => 'custom_box',
					'description' => __('Maximum weight that the custom box will hold.', 'woothemes'),
					'default' => ''
			    ),
			    'residential_address' => array(
					'title' => __('Residential address', 'woothemes'),
					'type' => 'checkbox',
					'label' => __('Ship to residential address', 'woothemes'),
					'description' => __('Turn on this option will assume you will ship to residential address always.
						UPS usually adds some surcharge to ship to residential address.', 'woothemes'),
					'default' => 'no'
			    ),
